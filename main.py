...
def attack(char_name: str, char_class: str) -> str:
    """Return a string with an include random attack value.
    which accords to a char_class.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Return a string with an include random defence value.
    which accords to a char_class.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return a string with an include random special value.
    which accords to a char_class.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Return strings making a fight training."""
    if char_class == 'warrior':
        print(f'{char_name}, ты Воитель — отличный '
              f'боец ближнего боя.')
    if char_class == 'mage':
        print(f'{char_name}, ты Маг — превосходный '
              f'укротитель стихий.')
    if char_class == 'healer':
...
def choice_char_class() -> str:
    """Return strings for choosing type of character."""
    approve_choice = None
    char_class = None
